const { OpTypes } = require("../op-utils")
...
function getExpressionName(opType) {
  // could expand this if required
  switch (opType) {
    case OpTypes.GET:
...
exports.updateParams = (condition, values, cndString) => {
  ...
  const expressionName = getExpressionName(condition.operation.getType())
